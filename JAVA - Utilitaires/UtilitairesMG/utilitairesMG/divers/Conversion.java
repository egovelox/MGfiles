...
// ==========================================================================
   ...
   public static long chaineLong(String chaine) throws NumberFormatException
   {
      long n;
...
// --------------------------------------------------------------------------
            if((chaineTravail.charAt(i) != '.') && (chaineTravail.charAt(i) != ' '))
            {
...
// --------------------------------------------------------------------------
               ...
               if (k == -1)
               {
                  throw new NumberFormatException("Caractere incorrect dans " + chaine);
               }
               else
...
// ==========================================================================
   ...
   public static double chaineDouble(String chaine) throws NumberFormatException
   {
      double r;
...
// --------------------------------------------------------------------------
               if (chaineTravail.charAt(i) == ',')
               {
                  ...
                  {
                     throw new NumberFormatException("Plus d'une virgule dans " + chaine);
                  }
               }
               else
