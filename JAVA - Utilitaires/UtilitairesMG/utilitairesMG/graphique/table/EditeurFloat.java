...
// fonctionne pas. Il faudra utiliser le meme format que celui du RenduFloat
...
public class EditeurFloat extends Editeur
{
...
// --------------------------------------------------------------------------
    ...
    public EditeurFloat(int ndec)
    {
        super(new JTextField());
        this.ndec = ndec;
    }

    public EditeurFloat(int ndec, int zero)
    {
        super(new JTextField());
        this.ndec = ndec;
        this.zero = zero;
    ...
    public EditeurFloat(int ndec, int zero, char separ)
    {
        super(new JTextField());
        this.ndec = ndec;
        this.zero = zero;
...
// --------------------------------------------------------------------------
// Le Float initial (value) contenue dans ce JTextField est formate (si
// possible comme celle du RenduFloat utilise pour l'affichage de la cellule.
// --------------------------------------------------------------------------
        ...
        int column)
    {
        ...
        if (value != null)
        {
            affichage = Conversion.doubleChaine((Float) value,
                ndec,
                zero,
                separ);
        }
...
// --------------------------------------------------------------------------
// Retourne la valeur contenue dans l'editeur (ici un Float).
// L'objet Float est reconstitue a partir de la chaine contenue dans le
// JTextField.
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// Mise a null ou conversion en Float du texte de la cellule
// --------------------------------------------------------------------------
        ...
        {
            retour = (float) Conversion.chaineDouble(texteCellule);
        }
