...
// --------------------------------------------------------------------------
   public void lire(Versement versement) throws ParserConfigurationException,
                                                SAXException,
                                                IOException
   {
      int rowCount;
...
// --------------------------------------------------------------------------
   public int creer(Versement versement) throws ParserConfigurationException,
                                                SAXException,
                                                IOException
   {
      int rowCount;
...
// --------------------------------------------------------------------------
   public int modifier(Versement versement) throws ParserConfigurationException,
                                                   SAXException,
                                                   IOException
   {
      int rowCount;
...
// --------------------------------------------------------------------------
   public int detruire(Versement versement) throws ParserConfigurationException,
                                                   SAXException,
                                                   IOException
   {
      int rowCount;
